...
object Anagrams {
  ...
  def wordOccurrences(w: Word): Occurrences =
    w.toLowerCase().toList.groupBy((a) => a).toList.map((a) => (a._1, a._2.length)).sorted
   ...
   *
   */
  lazy val dictionaryByOccurrences: Map[Occurrences, List[Word]] = loadDictionary.groupBy((a) => wordOccurrences(a))
  ...
  def reducedOn(occurrences: Occurrences, oc: Char, on: Int): Occurrences =
  ...
  def subtract(x: Occurrences, y: Occurrences): Occurrences =
    y.foldLeft(x)((x,o) => reducedOn(x, o._1, o._2))
