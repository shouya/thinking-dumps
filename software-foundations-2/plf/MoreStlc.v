...
Inductive has_type : context -> tm -> ty -> Prop :=
  ...
  (* let *)
  | T_Let : forall Gamma x v Tv t T,
      (Gamma |- v \in Tv) ->
      ((x |-> Tv; Gamma) |- t \in T) ->
      (Gamma |- let x = v in t \in T)
...
Proof with eauto.
  ...
  - (* T_Fst *)
    destruct IHHt; auto.
    right. inversion H; subst; try inversion Ht; subst...
    destruct H...
  - (* T_Snd *)
    destruct IHHt; auto.
    right. inversion H; subst; try inversion Ht; subst...
